...
@implementation BJFFMpegMovieManager
...
- (UIImage *)imageFromAVPicture
{
    ...
    struct SwsContext * imgConvertCtx = sws_getContext(_outputWidth,
                                                       _outputHeight,
                                                       AV_PIX_FMT_YUV420P,
                                                       _outputWidth,
                                                       _outputHeight,
